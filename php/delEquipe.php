...
<body>
    ...
    <section>
        ...
        <?php
            ...
            echo "<a href='deleteEquipe.php?id=$id' class='bt-container bt btn btn-success'>Sim </a>";
            echo "<a href='retornarEquipe.php' class='bt-container bt btn btn-danger'>Não</a>";
        ?>
    </section>

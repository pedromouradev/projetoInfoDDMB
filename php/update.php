...
<body>
    ...
    <section>
        ...
        <?php
            ...
            echo '<p class="text-white">Deseja Registrar o Atendimento?</p>';
            echo "<a href='up.php?id=$id' class='bt-container bt btn btn-success'>Sim </a>";
            echo "<a href='retornaPainel.php' class='bt-container bt btn btn-danger'>Não</a>";
        ?>
    </section>

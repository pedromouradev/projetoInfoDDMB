...
<body class="container-fluid">
    ...
    <table class="table table-hover table-dark">        
        ...
        <tbody>
            <?php
                $query = "select * from equipe where ativo = 1"; 
                ...
                if($rowcount != 0){
                    while($linha = $num->fetch_assoc()){
                        $codigo = $linha['codequipe'];
                        echo "<tr>";
                        echo "<td width='10%''> <img src='." . $linha['fotoprofessor'] . "' width='30%' heigth='30%'/> </td>";
                        echo "<td>" . $linha['nomeprofessor'] . "</td>";
                        echo "<td>" . $linha['funcaoprofessor'] . "</td>";
                        echo "<td> <a href='delEquipe.php?id=$codigo'> Excluir </a></td>";
